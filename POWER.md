...
This Power turns a Jira issue plus its linked Figma design into a disciplined iOS implementation workflow.
...
Search the repository before creating new architecture or components. Prefer the closest existing View/ViewController, ViewModel, coordinator/navigation flow, API client, model, design-system asset, and reusable UI component.
